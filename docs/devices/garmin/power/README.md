...
This is a quick document which shares my thoughts, and my suspicions will be tested in the near future.
...
| Mode                 |    Equivalent    | Description in fenix 8 owner's manual                        |
| -------------------- | :--------------: | ------------------------------------------------------------ |
