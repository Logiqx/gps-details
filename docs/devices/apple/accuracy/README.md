...
The Apple Watch Series 7 (and newer) sees continuous values for the horizontal accuracy estimates in watchOS 11.x (and newer). It should be noted that at the start of this example there are also values of 4.0 + 6.0 (multiples of 2) and 4.7x suggesting the legacy traits can still be present.
