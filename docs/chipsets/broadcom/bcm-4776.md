...
The BCM4776 was announced on 8 Jan 2020 in [GPSWorld](https://www.gpsworld.com/broadcoms-second-generation-dual-frequency-gnss-uses-l5-signals/). It is the second generation dual-frequency GNSS receivers from Broadcom.
