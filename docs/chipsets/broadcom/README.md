...
| ----------- | ------- | ------- | ------------------------------- | ----------- |
| Sep 2021 | [BCM4778](bcm-4778.md) | [BCM4778](https://www.broadcom.com/products/wireless/gnss-gps-socs/bcm4778) \* | L1 + L5 | Third generation dual-frequency GNSS receiver for mobile + wearables |
...
| ----------- | ------- | ------- | ----------- |
| Sep 2015 | [BCM4774](bcm-4774.md) | BCM47748 | GPS, GLONASS, BeiDou, Galileo, QZSS, tailored to wearable devices |
